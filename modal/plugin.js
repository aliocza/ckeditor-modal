...
CKEDITOR.plugins.add('modal', {
    ...
    init: function(editor) {
        ...
        editor.widgets.add('modal', {
            ...
            dialog: 'modalDialog',
            template: '<div class="modalWrapper">' + '<button type="button" class="btn btn-primary btn-lg modal-text" data-toggle="modal" data-target="#modal">' + 'Launch demo modal' + '</button>' + '<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">' + '<div class="modal-dialog" role="document">' + '<div class="modal-content">' + '<div class="modal-header">' + '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>' + '<h4 class="modal-title" id="myModalLabel">Modal title</h4>' + '</div>' + '<div class="modal-body">' + '...' + '</div>' + '<div class="modal-footer">' + '<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>' + '</div>' + '</div>' + '</div>' + '</div>' + '</div>',
